...
public class MissionInfo {
	 ...
	 */
	public void setSerialAgentsNumbers(List<String> serialAgentsNumbers) {this.serialAgentsNumbers = serialAgentsNumbers; }
	 ...
	 */
	public void setGadget(String gadget) {this.gadget = gadget; }
	 ...
	 */
	public void setTimeExpired(int timeExpired) {this.timeExpired = timeExpired; }
